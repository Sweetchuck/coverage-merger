...
use Robo\Tasks;
use Sweetchuck\CoverageMerger\Tests\Attributes\InitLintReporters;
...
/**
 * @phpstan-import-type PhpExecutable from \Sweetchuck\CoverageMerger\Tests\Phpstan
 */
class RoboFile extends Tasks implements LoggerAwareInterface, ConfigAwareInterface
{
    ...
    public function cmdBuildExecute(): TaskInterface
    {
        ...
        if ($this->environmentType === 'dev' && $this->environmentName === 'local-IGNORE') {
